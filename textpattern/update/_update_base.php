<?php
/*
$HeadURL: https://textpattern.googlecode.com/svn/releases/4.2.0/source/textpattern/update/_update.php $
...
*/
	...
	{
		echo graf(href("Version 4.0.2")).n;
	...
	{
		echo graf(href("Version 4.0.3")).n;
	...
	{
		echo graf(href("Version 4.0.4")).n;
	...
	{
		echo graf(href("Version 4.0.5")).n;
	...
	{
		echo graf(href("Version 4.0.6")).n;
	...
	{
		echo graf(href("Version 4.0.7")).n;
	...
	{
		echo graf(href("Version 4.0.8")).n;
	...
	{
		echo graf(href("Version 4.2.0")).n;
