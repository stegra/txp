		...
		function JScrollPane(elem, s)
		{
			...
			function initialise(s)
			{
				...
				*/
				...
				isScrollableH = percentInViewH > 1 && !settings.disableHorizontalScroll;
			...
			function initialiseVerticalScroll()
			{
				...
				container.find('>.jspVerticalBar').each( function() {
					createBar = false;
				});
			...
			{
				if (settings.disableFocusHandler) return;
