...
/*
$HeadURL: https://textpattern.googlecode.com/svn/releases/4.2.0/source/textpattern/lib/txplib_theme.php $
$LastChangedRevision: 3269 $
*/
...
//----------------------------------------
	...
	function set_state($area, $event, $is_popup, $message)
	{
		...
		$default_content_event = get_pref('default_event');
