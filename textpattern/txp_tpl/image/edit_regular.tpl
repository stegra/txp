...
<form name="resize_r">
	...
	<div id="regular-resize-box" class="resize">
		...
		<tr>
			...
			<td valign="middle"><input onChange="txp.edit.image.calcResize('r','width',{$w},{$h})" type="text" name="new_width" value="{$reg_w_new}" size="4" class="edit image" /></td>
			<td valign="middle">x</td>
			<td valign="middle"><input onChange="txp.edit.image.calcResize('r','height',{$w},{$h})" type="text" name="new_height" value="{$reg_h_new}" size="4" class="edit image" /></td>
