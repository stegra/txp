...
$HeadURL: https://textpattern.googlecode.com/svn/releases/4.2.0/source/textpattern/include/txp_tag.php $
$LastChangedRevision: 3195 $
...
<head>
	...
	<?php echo $theme->html_head($event); ?>
	</head>
<body id="tag-event">
<?php
